...
import com.example.comprapp.modelo.Supermercado;
...
public class SupermercadoDAO {
    ...
    private int insert(Supermercado supermercado) {
    ...
    private Supermercado getSupermercadoById(int id){
    ...
    private ArrayList<Supermercado> getSupermercadoList() {
        SQLiteDatabase db = dbHelper.getReadableDatabase();
        String selectQuery =  "SELECT  " +
                Supermercado.KEY_ID + "," +
                Supermercado.KEY_Nombre +
