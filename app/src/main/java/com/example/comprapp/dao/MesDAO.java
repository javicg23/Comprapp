...
import com.example.comprapp.modelo.Mes;
...
public class MesDAO {
    ...
    private ArrayList<Mes> getMesList() {
        SQLiteDatabase db = dbHelper.getReadableDatabase();
        String selectQuery =  "SELECT  " +
                Mes.KEY_ID + "," +
                Mes.KEY_Nombre + "," +
